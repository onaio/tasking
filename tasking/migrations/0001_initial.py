# Generated by Django 2.0.5 on 2018-05-25 07:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('a', 'Active'), ('b', 'Deactivated'), ('c', 'Expired'), ('d', 'Draft')], default='d', help_text='The status of the Task', max_length=1, verbose_name='Status')),
                ('lft', models.PositiveIntegerField(db_index=True, editable=False)),
                ('rght', models.PositiveIntegerField(db_index=True, editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('locations', models.ManyToManyField(blank=True, default=None, help_text='This represents the location.', to='tasking.Location', verbose_name='Location')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tasking.Task', verbose_name='Task Occurrence')),
            ],
            options={
                'abstract': False,
