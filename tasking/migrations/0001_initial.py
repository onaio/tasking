    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='children', to='tasking.Location')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, default=None, help_text='This represents the location.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='tasking.Location', verbose_name='Location')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_content_type', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='contenttypes.ContentType')),
                ('tasks', models.ManyToManyField(blank=True, default=None, help_text='This represents the Task.', to='tasking.Task', verbose_name='Tasks')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
