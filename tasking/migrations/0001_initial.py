    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved', models.BooleanField(default=False, help_text='This represents whether submission is approved or not.', verbose_name='Approved')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timing_rule', models.TextField(help_text='This stores the rrule for recurrence.', validators=[tasking.utils.validate_rrule], verbose_name='Timing Rule')),
                ...
                ('status', models.CharField(choices=[('a', 'Active'), ('b', 'Draft'), ('c', 'Closed')], default='b', help_text='The status of the Task', max_length=1, verbose_name='Status')),
                ('parent', models.ForeignKey(blank=True, default=None, help_text='This represents the parent task.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='tasking.Task', verbose_name='Parent task')),
                ('segment_rules', models.ManyToManyField(blank=True, default=None, to='tasking.SegmentRule', verbose_name='Segment Rules')),
        ...
        migrations.CreateModel(
            name='Location',
            fields=[
                ('baselocation_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='tasking.BaseLocation')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            name='Submission',
            fields=[
                ('basesubmission_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='tasking.BaseSubmission')),
                ('location', models.ForeignKey(blank=True, default=None, help_text='This represents the Location.', null=True, on_delete=django.db.models.deletion.PROTECT, to='tasking.Location', verbose_name='Location')),
            ],
            options={
                'abstract': False,
                'ordering': ['submission_time', 'task__name', 'id'],
            },
            bases=('tasking.basesubmission',),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='task',
            name='location',
            field=models.ForeignKey(blank=True, default=None, help_text='This represents the location.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='tasking.Location', verbose_name='Location'),
        ),
        migrations.AddField(
            model_name='submission',
            name='task',
            field=models.ForeignKey(help_text='This represents the Task.', on_delete=django.db.models.deletion.PROTECT, to='tasking.Task', verbose_name='Task'),
        ),
        migrations.AddField(
            model_name='submission',
            name='user',
