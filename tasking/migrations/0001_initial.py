# Generated by Django 2.0.5 on 2018-05-10 05:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(help_text='This represents the name of the Country.', max_length=255, verbose_name='Country')),
                ('geopoint', django.contrib.gis.db.models.fields.PointField(blank=True, default=True, help_text='This represents the Geographical Point of the Location.', null=True, srid=4326, verbose_name='GeoPoint')),
                ('radius', models.DecimalField(blank=True, decimal_places=4, default=None, help_text='This represents the radius of the Location.', max_digits=64, null=True, verbose_name='Radius')),
