# Generated by Django 2.0.5 on 2018-05-14 08:14
    ...
    operations = [
            ...
            fields=[
                ...
                ('geopoint',
                 django.contrib.gis.db.models.fields.PointField(
                     blank=True,
                     default=None,
                     help_text='This represents the Geographical Point of the '
                               'Location.',
                     null=True,
                     srid=4326,
                ...
                ('radius',
                 models.DecimalField(
                     ...
                     decimal_places=4,
                     default=None,
                     help_text='This represents the radius from the '
                     'geopoint.',
                     max_digits=64,
                     null=True,
                     verbose_name='Radius')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_time',
                 models.DateTimeField(
                     help_text='This is the date and time the task was '
                               'submitted.',
                     verbose_name='Submission Time')),
                ('valid',
                 models.BooleanField(
                     default=False,
                     help_text='This represents whether submission is valid '
                               'or not.',
                     verbose_name='Valid')),
                ('approved',
                 models.BooleanField(
                     default=False,
                     help_text='This represents whether submission is '
                               'approved or not.',
            ...
            fields=[
                ...
                ('user_submission_target',
                 models.IntegerField(
                     ...
                     default=None,
                     help_text='This is the total number of submissions '
                               'per user required for this task. Set to None '
                               'if there is no Max.',
                     null=True,
