# Generated by Django 2.0.5 on 2018-05-14 07:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='children', to='tasking.Location')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('location', models.ManyToManyField(blank=True, default=None, help_text='This represents the location.', to='tasking.Location', verbose_name='Location')),
                ('parent', mptt.fields.TreeForeignKey(blank=True, default=None, help_text='This represents the parent task.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='tasking.Task', verbose_name='Parent task')),
        ...
        migrations.AddField(
            model_name='project',
            name='tasks',
            field=models.ManyToManyField(blank=True, default=None, help_text='This represents the Task.', to='tasking.Task', verbose_name='Tasks'),
        ),
    ]
